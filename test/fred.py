...
wfdProfile = wfdProfile_example # String | The profile associated with the Word\
...
try:
    api_instance.stlabToolsFredGet(text, prefix=prefix, namespace=namespace,\
    wsd=wsd, wfd=wfd, wfdProfile=wfdProfile, tense=tense, roles=roles,\
    textannotation=textannotation, semanticSubgraph=semanticSubgraph)
